...
public class EbBrandDaoImpl extends SqlSessionDaoSupport implements EbBrandDao {
	...
	String ns = "com.fuyi.ecps.sqlMap.EbBrandMapper.";
	...
	public EbBrand getBrandById(Long brandId) {
		return this.getSqlSession().selectOne(ns + "selectByPrimaryKey",
				brandId);
	}
	...
	public List<EbBrand> selectBrandByName(String brandName) {
		return this.getSqlSession().selectList(ns + "selectBrandByName",
				brandName);
	}
