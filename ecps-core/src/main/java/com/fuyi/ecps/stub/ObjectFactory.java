 ...
 * generated in the com.fuyi.ecps.stub package. 
...
public class ObjectFactory {
    ...
    private final static QName _PublishItemResponse_QNAME = new QName("http://service.ws.ecps.fuyi.com/", "publishItemResponse");
    private final static QName _PublishItem_QNAME = new QName("http://service.ws.ecps.fuyi.com/", "publishItem");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.fuyi.ecps.stub
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.ws.ecps.fuyi.com/", name = "publishItemResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.ws.ecps.fuyi.com/", name = "publishItem")
