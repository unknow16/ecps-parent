 ...
 * 2017-10-13T20:03:27.514+08:00
 * Generated source version: 2.4.2
 * 
 */
@WebServiceClient(name = "EbWSItemServiceService", 
                  wsdlLocation = "http://localhost:8082/ecps-portal/services/publishItem?wsdl",
                  targetNamespace = "http://service.ws.ecps.fuyi.com/") 
public class EbWSItemServiceService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://service.ws.ecps.fuyi.com/", "EbWSItemServiceService");
    public final static QName EbWSItemServicePort = new QName("http://service.ws.ecps.fuyi.com/", "EbWSItemServicePort");
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8082/ecps-portal/services/publishItem?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(EbWSItemServiceService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8082/ecps-portal/services/publishItem?wsdl");
        }
        WSDL_LOCATION = url;
    }
