	...
	$(".spec a").click(function(){
		...
		$.ajax({
			...
			success:function(respText){
				var skuObj = $.parseJSON(respText);
				$("#skuPrice").html("￥" + skuObj.sku.skuPrice);
				$("#marketPrice").html("￥" + skuObj.sku.marketPrice);
				
				if(skuObj.sku.stockInventory > 0) {
					$("#stockState").html("有货");
					$("#buyNow").show();
					$("#addMyCart").show();
				} else {
		...
		<div class="product">
			...
			<form method="post" action="" name="" class="infor">
				...
				<div class="box_orange">
					...
					<input id="quantity" readonly type="text" name="" value="1" class="num" size="3" /><a href="javascript:void(0);" class="inb add"></a><em id="sub_add_msg" class="red"></em></li>
					<li class="submit">
					...
					<a href="#" title="加入收藏" class="inb fav">加入收藏</a></li>
