...
<div class="frameR"><div class="content">
    ...
    <h2 class="h2_ch">
      <span id="tabs" class="l">
        <a id="label1" href="${path}/order/listNoPay.do?assignee=noPaidOrderer"   title="全部" class="nor">全部</a>
        <a id="label2" href="${path}/order/listNoPay.do?isCall=0&assignee=noPaidOrderer"   title="未付款待外呼" class="nor">未付款待外呼</a>  
        <a id="label3" href="${path}/order/listNoPay.do?isCall=1&assignee=noPaidOrderer"   title="已外呼" class="nor">已外呼</a>
<%--         <a id="label4" href="${path}/order/orderPay.do?orderState=17"  title="超时作废" class="nor">超时作废</a> --%>
   ...
   <table cellspacing="0" summary="" class="tab" id="myTable">
    ...
    <c:forEach items="${noPaidOrderList }" var="tb">
	    <tr>
