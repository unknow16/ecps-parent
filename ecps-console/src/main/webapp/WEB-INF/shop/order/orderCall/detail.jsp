...
<body id="main">
	...
	<form id="form1" action="${path }/order/completeTask.do" method="post">
	...
	<div class="frameR"><div class="content">
				...
				<form id="myForm" action="${path}/order/orderPay/oper.do"
					...
					<div class="sch page_c">
						<span class="l">订单号：
						<b class="red"><var>${tb.order.orderNum}</var></b>&nbsp;&nbsp;&nbsp;
						下单时间：<var><fmt:formatDate value="${tb.order.orderTime}" pattern="yyyy-MM-dd HH:mm:ss" /></var>&nbsp;&nbsp;&nbsp;
						<b class="f14 blue">
